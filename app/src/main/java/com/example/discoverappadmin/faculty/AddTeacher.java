...
import com.example.discoverappadmin.NoticeData;
import com.example.discoverappadmin.R;
import com.example.discoverappadmin.UploadNotice;
...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Computer Science", "Mathematics", "Electrical", "Mechanical"};
    ...
    private void checkValidation() {
        ...
        if(name.isEmpty()) {
            ...
            Toast.makeText(AddTeacher.this, "Please select a Category", Toast.LENGTH_SHORT).show();
        }else if(bitmap == null) {
